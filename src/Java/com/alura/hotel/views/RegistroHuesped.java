...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(RegistroHuesped.class.getResource("/com/alura/hotel/imagenes/lOGO-50PX.png")));
		...
		txtFechaN.getCalendarButton().setIcon(
				new ImageIcon(RegistroHuesped.class.getResource("/com/alura/hotel/imagenes/icon-reservas.png")));
