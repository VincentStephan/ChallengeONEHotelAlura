...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(MenuUsuario.class.getResource("/com/alura/hotel/imagenes/aH-40px.png")));
		...
		lblNewLabel_2.setIcon(new ImageIcon(MenuUsuario.class.getResource("/com/alura/hotel/imagenes/aH-150px.png")));
		...
		labelRegistro.setIcon(new ImageIcon(MenuUsuario.class.getResource("/com/alura/hotel/imagenes/reservado.png")));
		labelRegistro.setForeground(SystemColor.text);
		labelRegistro.setBounds(36, 11, 194, 34);
		...
		btnBusqueda.setLayout(null);
				...
				lblBusquedaDeReservas
						.setIcon(new ImageIcon(MenuUsuario.class.getResource("/com/alura/hotel/imagenes/pessoas.png")));
		...
		btnSalir.setBackground(new Color(12, 138, 199));
		btnSalir.setBounds(0, 379, 257, 56);
		panelMenu.add(btnSalir);
		
		JLabel lblSalir = new JLabel("Salir");
		lblSalir.setIcon(new ImageIcon(MenuUsuario.class.getResource("/com/alura/hotel/imagenes/cerrar-24px.png")));
		lblSalir.setHorizontalAlignment(SwingConstants.LEFT);
		lblSalir.setForeground(SystemColor.text);
		lblSalir.setFont(new Font("Dialog", Font.PLAIN, 18));
		lblSalir.setBounds(33, 11, 197, 34);
